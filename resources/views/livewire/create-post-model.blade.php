<div class="h-[50rem] flex flex-col justify-center">
    ...
    @if ($image)
    <img class="h-full w-full object-contain" src="{{ $image->temporaryUrl() }}"> 
   @endif
    @if (!$image)
        <div class="grow flex flex-col h-full items-center justify-center">
            ...
            <div class="text-center mb-5">
                <input type="file" class="hidden" id="fileInput" wire:model.live.lazy="image">
                <x-primary-button class="mt-4" onclick="document.getElementById('fileInput').click()">{{ __('Select from computer') }}</x-primary-button>
